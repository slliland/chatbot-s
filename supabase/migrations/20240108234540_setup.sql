...
AS $$
DECLARE
  project_url TEXT := 'https://csgzuvrpdrarqceqjukm.supabase.com';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNzZ3p1dnJwZHJhcnFjZXFqdWttIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyOTI2NDc5OSwiZXhwIjoyMDQ0ODQwNzk5fQ.HQ9ZomTlwfdBYzEZDfYVyrbADtDGRPQoPQxo_r1mADs'; -- full access needed for http request to storage
